                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title"><i class="<?php echo e($template->icon); ?>"></i> Form Tambah <?php echo e($template->title); ?></h3>                            
                        </div>
                        <form action="<?php echo e(route("$template->route".".store")); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="box-body">                            

...
<body class="hold-transition {{$template->theme}} sidebar-mini">
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">                        
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{Auth::guard('admin')->user()->foto != '' ? asset('image').'/'.Auth::guard('admin')->user()->foto : asset('admin-lte').'/dist/img/avatar5.png'}}" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="{{Auth::guard('admin')->user()->foto != '' ? asset('image').'/'.Auth::guard('admin')->user()->foto : asset('admin-lte').'/dist/img/avatar5.png'}}" class="img-circle" alt="User Image">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019 <a target="__blank" href="https://badungkab.go.id">Pemerintah Kabupaten Badung </a>
        </footer>
